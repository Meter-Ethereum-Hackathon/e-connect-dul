...
function MyMongoDB() {
    ...
    myDB.createCard = async (user, card) => {
        ...
        try {
            ...
            const puclicCol = database.collection("publiccard");
            ...
            await puclicCol.insertOne(card);
    ...
    myDB.addPublicCard = async (user, card) => {
        const client = new MongoClient(url);
        try {
            await client.connect();
            const database = client.db(DB_NAME);
    ...
    myDB.deleteCard = async (currentUser, id) => {
        ...
        try {
            ...
            console.log("ddddd current user", currentUser);
            console.log("cdddd urrent id", id);
